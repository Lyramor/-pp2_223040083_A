...
public class HelloFlowLayout extends JFrame {
    ...
    public HelloFlowLayout() {
        // Menentukan tindakan saat jendela ditutup
        ...
        // Mengatur layout menjadi FlowLayout (Default alignment: Center)
    ...
    public static void main(String[] args) {
        // Membuat GUI pada thread yang aman
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                // Membuat instance dari HelloFlowLayout dan menampilkannya
